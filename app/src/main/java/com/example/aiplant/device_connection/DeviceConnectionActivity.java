package com.example.aiplant.device_connection;
...
import com.example.aiplant.welcome.PrefManager;
...
public class DeviceConnectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.fragment_one_connect,
                R.layout.fragment_two_connect,
                R.layout.fragment_three_connect,
                };
    ...
    private void addBottomDots(int currentPage) {
        ...
        int[] colorsActive = getResources().getIntArray(R.array.array_dot_active_connect);
        int[] colorsInactive = getResources().getIntArray(R.array.array_dot_inactive_connect);
